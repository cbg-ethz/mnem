...
to analyzse heterogeneous cell populations. We extended the original
...
fig.cap6 <- "Histograms of the responsibilities. The responsibilties for the
highest scoring according to the penelized loglikelihood for the CROPSeq (A)
...
```{r, fig.width = 4, fig.height = 4, warning=FALSE, fig.cap = fig.cap4}
runs <- 100
maxk <- 5
...
The following code was used to generate the data for the simulation and
    application results. See the accompanying R code.
