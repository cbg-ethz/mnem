...
This R code was used to generate the data object 'app'. It also
includes the code for the simulations from the method paper
(Pirkl & Beerenwinkel 2018) to which we refer you for more details.
