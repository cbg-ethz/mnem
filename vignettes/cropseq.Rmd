...
load("cropseq_mnem_agg.rda")
load("cropseq_kegg.rda")
...
par(mar=c(5,5,1,5))
plot(bics, type = "b", ylab = "AIC", col = "red", xlab = "AIC (red) and log likelihood (blue) as a function of number of components", yaxt = "n", ylim = c(min(ll), max(ll)))
...
## mtext("A", side = 3, line = 1, outer = FALSE, cex = 2.5, adj = 0,
