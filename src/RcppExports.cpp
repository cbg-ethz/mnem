...
RcppExport SEXP _mnem_armaMatMult(SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _mnem_eigenMatMult(SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_mnem_armaMatMult", (DL_FUNC) &_mnem_armaMatMult, 2},
    {"_mnem_eigenMatMult", (DL_FUNC) &_mnem_eigenMatMult, 2},
